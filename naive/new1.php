      ...
      <div class="card rounded shadow border-0">
        <div class="card-body p-5 bg-white rounded">
          <div class="table-responsive">
            ...
            <table id="search" class="table table-striped table-bordered display  responsive nowra" style="width: 100%">
                <thead>
                <tr>
                ...
                if ($result = $conn->query($sql)) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
							...
							<td><a href='downloadevidence.php?id=<?php echo $row["id"]; ?>'>Download</a></td>
