...
'was','what','when','where','who','will','with','und','the','www');
 ...
 if ($bodyTextIsHam >= $bodyTextIsSpam && $bodyTextIsHam >=$bodyTextIscc && $bodyTextIsHam >= $bodyTextIsrr && $bodyTextIsHam >=
$bodyTextIsvt && $bodyTextIsHam >= $bodyTextIset) {
 $category = $murder;
 } else if ($bodyTextIsSpam >= $bodyTextIsHam &&
$bodyTextIsSpam >= $bodyTextIscc && $bodyTextIsSpam >= $bodyTextIsrr &&
$bodyTextIsSpam >= $bodyTextIsvt && $bodyTextIsSpam >= $bodyTextIset){
 $category = $pp;
 }
 else if ($bodyTextIscc >= $bodyTextIsHam && $bodyTextIscc >=
$bodyTextIsSpam && $bodyTextIscc >= $bodyTextIsrr && $bodyTextIscc >=
$bodyTextIsvt && $bodyTextIscc >= $bodyTextIset){
 $category = $cc;
 }
 else if ($bodyTextIsrr >= $bodyTextIsHam && $bodyTextIsrr >=
$bodyTextIsSpam && $bodyTextIsrr >= $bodyTextIscc && $bodyTextIsrr >=
$bodyTextIsvt && $bodyTextIsrr >= $bodyTextIset){
 $category = $rr;
 }
 else if ($bodyTextIset >= $bodyTextIsHam && $bodyTextIset >=
$bodyTextIsSpam && $bodyTextIset >= $bodyTextIscc && $bodyTextIset >=
$bodyTextIsvt && $bodyTextIset >= $bodyTextIsrr){
 $category = $et;
 }
 else if ($bodyTextIsvt >= $bodyTextIsHam && $bodyTextIsvt >=
$bodyTextIsSpam && $bodyTextIsvt >= $bodyTextIscc && $bodyTextIsvt >=
$bodyTextIset && $bodyTextIsvt >= $bodyTextIsrr){
 $category = $vt;
 }
 $conn -> close();
 return $category;
